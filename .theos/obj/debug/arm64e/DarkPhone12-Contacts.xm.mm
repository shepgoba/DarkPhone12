...
@class CNContactListTableViewCell; @class CNPropertyEmailAddressCell; @class CNActionsView; @class CNPropertyPhoneNumberCell; @class UITableViewLabel; @class CNContactActionCell; @class CNContactHeaderDisplayView; @class CNContactListTableView; 
