...
@class CNContactListTableView; @class CNPropertyEmailAddressCell; @class CNContactActionCell; @class CNPropertyPhoneNumberCell; @class UITableViewLabel; @class CNActionsView; @class CNContactListTableViewCell; @class CNContactHeaderDisplayView; 
