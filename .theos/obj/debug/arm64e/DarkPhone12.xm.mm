...
@class UICollectionView; @class UITableView; @class UINavigationController; @class UITableViewCell; @class UILabel; @class UIViewController; @class UIView; @class _UINavigationBarLargeTitleView; @class UITextView; @class UITextField; @class _UIVisualEffectSubview; @class _UINavigationBarContentView; 
...
static __attribute__((constructor)) void _logosLocalCtor_47d1e990(int __unused argc, char __unused **argv, char __unused **envp)
{
