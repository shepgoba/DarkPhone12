...
@class UINavigationController; @class UITableView; @class UITextView; @class UINavigationBar; @class UIView; @class _UIVisualEffectSubview; @class UIViewController; @class _UINavigationBarContentView; @class UICollectionView; @class UITableViewCell; @class UITextField; @class UILabel; 
