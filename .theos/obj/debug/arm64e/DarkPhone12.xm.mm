...
@class TPNumberPadButton; @class UIAlertController; @class _UIVisualEffectSubview; @class UITableViewCell; @class UIView; @class UIViewController; @class CNContactListTableViewCell; @class CNContactActionCell; @class UITableViewLabel; @class CNActionsView; @class UILabel; @class PHHandsetDialerNumberPadButton; @class CNPropertyEmailAddressCell; @class CNContactListHeaderFooterView; @class CNContactHeaderDisplayView; @class UICollectionView; @class UITextView; @class CNPropertyPhoneNumberCell; @class PHHandsetDialerDeleteButton; @class UITextField; @class UITableView; @class PHHandsetDialerView; @class UINavigationBar; @class _UINavigationBarContentView; @class UINavigationController; @class CNContactListTableView; 
