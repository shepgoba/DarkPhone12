...
static __attribute__((constructor)) void _logosLocalCtor_d296c101(int __unused argc, char __unused **argv, char __unused **envp)
{
    initPrefs();
    loadPrefs();
