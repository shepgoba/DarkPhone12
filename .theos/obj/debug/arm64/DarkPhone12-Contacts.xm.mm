...
@class CNContactListTableViewCell; @class CNPropertyEmailAddressCell; @class CNContactHeaderDisplayView; @class CNActionsView; @class UITableViewLabel; @class CNContactActionCell; @class CNContactListTableView; @class CNPropertyPhoneNumberCell; 
