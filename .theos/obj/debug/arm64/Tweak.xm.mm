...
@class CNPropertyEmailAddressCell; @class UILabel; @class CNPropertyPhoneNumberCell; @class _UINavigationBarContentView; @class PHHandsetDialerView; @class CNContactHeaderDisplayView; @class PHHandsetDialerDeleteButton; @class UITextField; @class PHHandsetDialerNumberPadButton; @class _UINavigationBarLargeTitleView; @class UIView; @class UITextView; @class CNContactView; @class UITableView; @class CNContactActionCell; @class UITableViewCell; @class CNContactListTableView; @class UIViewController; @class CNContactListTableViewCell; @class _UIVisualEffectSubview; @class CNActionsView; 
