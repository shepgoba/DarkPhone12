...
@class PHHandsetDialerNumberPadButton; @class CNContactListTableViewCell; @class CNActionsView; @class CNContactListTableView; @class CNContactActionCell; @class UILabel; @class CNPropertyEmailAddressCell; @class _UIVisualEffectSubview; @class UITableViewCell; @class UITextField; @class _UINavigationBarLargeTitleView; @class PHHandsetDialerDeleteButton; @class CNPropertyPhoneNumberCell; @class UITableView; @class UIViewController; @class PHHandsetDialerView; @class _UINavigationBarContentView; @class UIView; @class CNContactHeaderDisplayView; 
