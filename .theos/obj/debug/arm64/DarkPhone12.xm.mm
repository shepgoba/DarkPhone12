...
@class _UINavigationBarContentView; @class UITextField; @class _UIVisualEffectSubview; @class _UINavigationBarLargeTitleView; @class UIViewController; @class UILabel; @class UITextView; @class UITableView; @class UITableViewCell; @class UINavigationController; @class UIView; 
...
static __attribute__((constructor)) void _logosLocalCtor_42a0e188(int __unused argc, char __unused **argv, char __unused **envp)
{
