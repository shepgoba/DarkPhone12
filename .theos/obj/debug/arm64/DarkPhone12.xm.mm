...
@class CNPropertyPhoneNumberCell; @class CNContactListTableView; @class UINavigationController; @class UITextView; @class PHHandsetDialerDeleteButton; @class CNContactListTableViewCell; @class CNContactHeaderDisplayView; @class UILabel; @class _UIVisualEffectSubview; @class _UINavigationBarContentView; @class CNContactActionCell; @class CNPropertyEmailAddressCell; @class UIView; @class UINavigationBar; @class UIViewController; @class PHHandsetDialerNumberPadButton; @class UITableView; @class UICollectionView; @class UITextField; @class CNActionsView; @class UITableViewCell; @class PHHandsetDialerView; @class UITableViewLabel; 
