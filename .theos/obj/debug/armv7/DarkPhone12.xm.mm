...
@class _UINavigationBarLargeTitleView; @class UITableViewCell; @class _UINavigationBarContentView; @class UIViewController; @class UIView; @class UITextView; @class UITextField; @class _UIVisualEffectSubview; @class UITableView; @class UILabel; 
...
static void _logos_method$_ungrouped$UIView$setBackgroundColor$(_LOGOS_SELF_TYPE_NORMAL UIView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UIColor * arg1) {
    _logos_orig$_ungrouped$UIView$setBackgroundColor$(self, _cmd, arg1);
...
static __attribute__((constructor)) void _logosLocalCtor_4c56ff4c(int __unused argc, char __unused **argv, char __unused **envp)
{
